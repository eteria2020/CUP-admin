// Define Glbal vars
/* global $:true, translate:true, d3:true, dc:true, crossfilter:true, ol:true $ document window setInterval clearInterval clearTimeout setTimeout */
...
$.oe.fn.createButtons = function(){
    $.each($.oe.city, function(key, val){
        ...
        $("#header-buttons").prepend("<button type=\"button\" class=\"btn btn-default\" id=\"pan-to-" + val.fleet_code + "\">"+ translate("Spostati su") + " " + val.fleet_name + "</button>");
